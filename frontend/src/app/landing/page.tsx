const statusItems = [
  { label: "Pending", detail: "Awaiting on-chain confirmation", cls: "pending_payment" },
...
const howItWorks = [
  ...
  },
  {
    ...
    videoUrl: "https://videos.pexels.com/video-files/5849934/5849934-uhd_2560_1440_25fps.mp4",
    posterUrl:
  ...
  },
  {
    ...
    videoUrl: "https://videos.pexels.com/video-files/7567474/7567474-uhd_2560_1440_25fps.mp4",
    posterUrl:
  ...
  return (
    <main className="min-h-screen app-bg text-[var(--app-fg)]">
      <div className="mx-auto w-full max-w-6xl px-4 py-8 md:py-12 space-y-8 md:space-y-10">
        <div className="sticky top-2 z-30 rounded-2xl border app-surface/95 backdrop-blur px-3 py-2 shadow-sm">
            ...
            <div className="rounded-2xl border border-white/20 bg-slate-950/65 p-4 md:p-5 text-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-300">Live operational view</p>
                </div>
              </div>
        ...
        <section id="problem" className="grid gap-4 md:grid-cols-3 scroll-mt-24">
          {painPoints.map((item) => (
        ...
        <section id="how-it-works" className="rounded-3xl border app-surface p-6 md:p-8 shadow-sm scroll-mt-24">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            {howItWorks.map((item) => (
              <article key={item.step} className="overflow-hidden rounded-2xl border">
        ...
        <section id="credibility" className="rounded-3xl border app-surface p-6 md:p-8 shadow-sm scroll-mt-24">
        ...
        <section id="faq" className="rounded-3xl border app-surface p-6 md:p-8 shadow-sm scroll-mt-24">
